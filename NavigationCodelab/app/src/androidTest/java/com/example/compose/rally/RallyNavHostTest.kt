...
class RallyNavHostTest {
    ...
    fun rallyNavHost_navigateToAllAccounts_viaUI() {
        composeTestRule
            ...
            .performClick()
        composeTestRule
            .onNodeWithText("Accounts Screen")
            .assertIsDisplayed()
    ...
    fun rallyNavHost_navigateToBills_viaUI() {
        ...
        // Then the route is "Bills". Not true, the backstack holds the previous screen we were on, which is "Overview".
        val route = navController.currentBackStackEntry?.destination?.route
        assertEquals("Overview", route)
    }
